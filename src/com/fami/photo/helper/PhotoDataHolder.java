...
public class PhotoDataHolder {
    ...
    private static PhotoDataHolder dataHolder;
    private int signInUserId;
    private List<QBFile> qbFileList;

    public static synchronized PhotoDataHolder getDataHolder() {
        if (dataHolder == null) {
            dataHolder = new PhotoDataHolder();
        }
        return dataHolder;
    }
