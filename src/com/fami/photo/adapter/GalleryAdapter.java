package com.fami.photo.adapter;
...
public class GalleryAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount() {
        return PhotoDataHolder.getDataHolder().getQbFileListSize();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageLoader.getInstance().displayImage(
                Constants.URL_S3 + PhotoDataHolder.getDataHolder().getPublicUrl(position),
